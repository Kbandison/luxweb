...
export const metadata: Metadata = {
  ...
  description: "Explore our portfolio of successful web development projects. See how we've helped businesses across various industries grow with professional, conversion-focused websites.",
}
