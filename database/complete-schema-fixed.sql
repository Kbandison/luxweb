-- LuxWeb Studio CRM - Complete Database Schema (CORRECTED PACKAGES)
...
CREATE TABLE contact_submissions (
  ...
  phone TEXT,
  company TEXT,
  project_type TEXT CHECK (project_type IN ('starter', 'growth', 'complete', 'enterprise')) NOT NULL,
  project_goals TEXT,
...
CREATE TABLE projects (
  ...
  project_type TEXT CHECK (project_type IN ('starter', 'growth', 'complete', 'enterprise', 'custom')) NOT NULL,
  description TEXT,
...
-- ================================
-- SEED DATA - CORRECT PACKAGES FROM data/packages.ts
-- ================================
...
-- Create admin user for your personal email
